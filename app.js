...
const { historyInformation } = require('./controllers/autentication.controller.js')
 //-------------------------------------------
...
app.get('/api/informacion-historia', (request, response) =>{
    response.send(JSON.stringify(historyInformation));
    console.log(JSON.stringify(historyInformation));
});
